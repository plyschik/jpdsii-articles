        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form id="dashboard_user_edit" action="{{ route('dashboard.users.edit', ['user' => $user]) }}" method="POST">
                        @method('PATCH')
                        <div class="box-body">
                            ...
                            <div class="form-group{{ $errors->has('role_id') ? ' has-error' : '' }}">
                                <label for="role">{{ __('messages.dashboard.users.create.form.role') }}</label>
                        ...
                        <div class="box-footer">
                            <button class="btn btn-primary" type="submit">{{ __('messages.dashboard.users.edit.form.submit') }}</button>
                        </div>
                        @csrf
                    </form>
                </div>
